    ...
    public class MovieRepository
    {
        ...
        static MovieRepository()
        {
            _movies = new List<Movie>()
            {
                ...
                new Movie(){MovieId = 5, Title = "Eternal Sunshine of the Spotless Mind", Description = "When their relationship turns sour, a couple undergoes a medical procedure to have each other erased from their memories for ever.", Director = "Michel Gondry", Actors = new string[]{"Jim Carrey", "Kate Winslet"}, ImageUrl = "5.jpg", GenreId = 4},
